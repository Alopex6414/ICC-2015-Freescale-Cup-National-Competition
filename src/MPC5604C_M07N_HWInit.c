...
/*
 *
 * FILE : MPC5604C_M07N_HWInit.c
 *
 * DESCRIPTION:
 *  This file contains all MPC5604C_M07N derivative needed initializations, 
 *  and all initializations for the MPC5604C_M07N boards which are supported.
...
#include "MPC5604C_M07N.h"      /* MPC56xx platform development header            */
#include "MPC5604C_M07N_HWInit.h"
...
/*******************************************************/
/* MPC5604C_M07N derivative specific hardware initialization */
/*******************************************************/
...
nofralloc
    ...
    /* MPC5604C_M07N SRAM initialization code                              */
...
/*******************************************************/
/* MPC5604C_M07N boards specific hardware initializations    */
/*******************************************************/
...
#if INIT_USED_BOARD==MPC5604C_M07NDEMO_AXM_0321
/* Symbol AXM_0321_EXTERNAL_RAM is defined in the application linker command file (.lcf) 
   It is defined to the start of the external memory on the MPC5604C_M07NDEMO_AXM-0321 board 
*/
...
nofralloc
    ...
    /*  This initializes the MPC5604C_M07N external bus
        Set up the pins
